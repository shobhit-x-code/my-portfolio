      ...
      <Container>
        ...
        <div className="mt-8 grid items-start gap-8 xl:grid-cols-[380px_minmax(0,1fr)_240px]">
            ...
            <div className="relative pl-[3px] pt-[3px]">
              ...
              <div className="rounded-tl-[3.75rem] rounded-br-[3.75rem] border-[3px] border-white bg-bg-1 px-6 py-8 sm:px-8">
                ...
                <div className="mt-6 text-center">
                  <h2 className="type-h2 text-white">Shobhit Nair</h2>
                  <p className="type-media mt-3 text-brand-2">
                    Fullstack Developer
                  </p>
                </div>

                <div className="mt-8 space-y-4">
                  {heroProfileDetails.map((detail) => (
                    <div
                      key={`${detail.icon}-${detail.value}`}
                      className="grid grid-cols-[14px_minmax(0,1fr)] items-center gap-4"
                    >
                      <span>{iconMap[detail.icon]}</span>
                      <p className="type-media break-words text-white">{detail.value}</p>
                    </div>
                  ))}
                </div>
          ...
          <div className="pt-4 xl:pt-14">
            ...
            <a
              href="mailto:shobhitnair@example.com"
              className="mt-6 inline-flex items-center gap-3 text-brand-1 transition hover:text-brand-2"
            >
              <span>{iconMap.email}</span>
              <span className="type-button">let&apos;s talk</span>
            </a>
          </div>
          ...
          <div className="rounded-[2rem] bg-bg-2 p-6 sm:p-8 xl:mt-12">
            <div className="space-y-8">
              {heroStats.map((item) => (
                ...
                >
                  <p className="type-number text-brand-1">{item.value}</p>
                  <p className="type-media mt-2 text-white/78">{item.label}</p>
                </div>
              ))}
            </div>
          </div>
